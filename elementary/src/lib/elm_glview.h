 ...
 *
 * Below is an illustrative example of how to use GLView and OpenGL
 * to render in the elementary environment.
 ...
 *       direct rendering. Please refer to @ref evas_gl_direct_rendering "Evas GL"
 ...
 *
 * @param[in] parent The parent object
 * @param[in] version Requested GL ES version number (default is 2.x)
 * @return The new object, otherwise @c NULL if it cannot be created
 */
