 ...
 *
 * An Elementary image object is a direct realization of @ref elm-image-class.
 *
 ...
 *
 * An example of the usage for this API is as follows:
...
/**
 * @brief Set this flag to true in order to run fully asynchronous file open.
 *
 * Opening a file asynchronously can provide drastic performance
 * improvements on file systems with very slow I/O, such as slow disks.
 *
 * @since_tizen 2.3
 */
