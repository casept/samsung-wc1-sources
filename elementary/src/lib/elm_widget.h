...
// TIZEN ONLY (20140613) : Added checking if widget can get focus.
   Eina_Bool        (*focusable_is) (Evas_Object* obj,
                                     ...
                                     Evas_Coord y);
//
   void  (*sound_effect_enabled_set)(Evas_Object *obj,
                                     Eina_Bool enable);
   Eina_Bool  (*sound_effect_enabled_is)(const Evas_Object *obj);

   // TIZEN ONLY: This is for UI Analyzer information.
   char *           (*description_get)(const Evas_Object *obj);
...
void                  _elm_access_highlight_read_enable_set(Evas_Object *obj, Eina_Bool enabled, Eina_Bool access_enable);
