 ...
 * @since_tizen 2.3
 *
 * @param[in] friction The standard thumb scroll friction
 *
 ...
 * @since_tizen 2.3
 *
 * @param[in] threshold The thumb scroll acceleration time limit
 *
 ...
 * @since_tizen 2.3
 *
 * @param[in] threshold The thumb scroll acceleration weight
 *
 ...
 * @since_tizen 2.3
 *
 * @param[in] lonpress_timeout The timeout for a long press event
 */
 ...
 *
 * @param[in] is_accesss If @c EINA_TRUE it enables the access mode, otherwise @c EINA_FALSE
 *
 ...
 * @since_tizen 2.3
 *
 * @param[in] long_tap_timeout The timeout for the double tap event of the gesture layer
 */
