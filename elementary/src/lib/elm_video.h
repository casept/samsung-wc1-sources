 ...
 *
 * @param[in] video The video object to proceed the request on
 * @return @c EINA_TRUE if it is possible to seek inside the video,
 ...
 *
 * @param[in] video The video object
 * @param[in] The boolean value that indicates the last played position of the Elm_Video object
 */
