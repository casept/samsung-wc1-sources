 ...
 *
 * @param[in] obj The gesture-layer
 * @param[in] fsize The finger size
 *
 */
...
EAPI void elm_gesture_layer_zoom_threshold_set(Evas_Object *obj, Evas_Coord zoom_threshold);

EAPI Evas_Coord elm_gesture_layer_zoom_threshold_get(const Evas_Object *obj);
