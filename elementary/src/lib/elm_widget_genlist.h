...
#define MAX_ITEMS_PER_VIEWPORT 17
...
struct _Elm_Genlist_Smart_Data
{
   ...
   Eina_Bool                             on_hold : 1; /* a flag for check
                                                       * item selected or
                                                       * not */
   Eina_Bool                             access_prev_item: 1;
   Eina_Bool                             access_next_item: 1;
  ...
  /*for banded ux*/
   ...
   Eina_Bool                             banded_mode : 1;
   const char                            *item_bg_color_class;
   const char                            *list_bg_color_class;
#endif
};
...
struct _Item_Cache
{
   ...
   const Elm_Gen_Item_Class *itc; //it->itc
