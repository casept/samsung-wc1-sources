...
EAPI void _access_highlight_read_block_object_add(Evas_Object* obj);
EAPI void _access_highlight_read_block_object_remove(Evas_Object* obj);
EAPI Eina_Bool _access_highlight_is_read_block_object(Evas_Object* obj);
EAPI Eina_Bool _elm_access_object_lower_than_target(Evas_Object *obj, const char *target);
