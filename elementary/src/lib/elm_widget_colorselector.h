...
enum _Colorselector_Color_Component {
   COLORSELECTOR_COLOR_COMPONENT_B,
   COLORSELECTOR_COLOR_COMPONENT_G,
   COLORSELECTOR_COLOR_COMPONENT_R,
   COLORSELECTOR_COLOR_COMPONENT_A,
   COLORSELECTOR_COLOR_COMPONENT_NUM,
};
