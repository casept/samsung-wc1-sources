...
#ifdef __TIZEN__
typedef enum {
  PULSESRC_LATENCY_LOW = 0,
  PULSESRC_LATENCY_MID,
  PULSESRC_LATENCY_HIGH,
} GstPulseSrcLatency;

enum {
  PULSESRC_LOCAL_CONFIGURATION_LOW,
  PULSESRC_LOCAL_CONFIGURATION_MID,
  PULSESRC_LOCAL_CONFIGURATION_HIGH,
  PULSESRC_LOCAL_CONFIGURATION_MAX,
};
...
struct _GstPulseSrc
{
  ...
  gint buffer_time[PULSESRC_LOCAL_CONFIGURATION_MAX];
  gint latency_time[PULSESRC_LOCAL_CONFIGURATION_MAX];
  gint readcnt;
