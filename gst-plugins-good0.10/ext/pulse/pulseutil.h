...
#ifdef __TIZEN__
enum {
  PULSE_LOCAL_CONFIGURATION_LOW,
  PULSE_LOCAL_CONFIGURATION_MID,
  PULSE_LOCAL_CONFIGURATION_HIGH,
  PULSE_LOCAL_CONFIGURATION_VERY_HIGH,
  PULSE_LOCAL_CONFIGURATION_MAX = PULSE_LOCAL_CONFIGURATION_VERY_HIGH,
};

typedef enum {
  SUPPORT_TYPE_DEFAULT,
  SUPPORT_TYPE_MIRRORING,
  SUPPORT_TYPE_VOICECONTROL,
  SUPPORT_TYPE_SVR,
  SUPPORT_TYPE_VIDEOCALL,
  SUPPORT_TYPE_VOICERECORDING,
  SUPPORT_TYPE_VOIP,
  SUPPORT_TYPE_CALL_FORWARDING,
  SUPPORT_TYPE_FMRADIO,
  SUPPORT_TYPE_LOOPBACK,
} GstPulseAudioSupportType;
#endif
...
#ifdef __TIZEN__
void gst_pulse_set_policy(pa_proplist *proplist, gint support_type);
#endif
#endif
