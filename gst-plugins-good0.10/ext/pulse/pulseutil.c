...
{
  switch (support_type) {
    case SUPPORT_TYPE_VIDEOCALL:
      pa_proplist_sets(proplist, PA_PROP_MEDIA_POLICY, "voip");
      break;
    case SUPPORT_TYPE_MIRRORING:
      pa_proplist_sets(proplist, PA_PROP_MEDIA_POLICY, "mirroring");
      break;
    case SUPPORT_TYPE_LOOPBACK:
      pa_proplist_sets(proplist, PA_PROP_MEDIA_POLICY, "loopback");
      break;
    default:
