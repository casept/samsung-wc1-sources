...
TEST_F(EWK2UnitTestBase, ewk_view_add)
{
...
TEST_F(EWK2UnitTestBase, ewk_view_navigation)
{
    ...
    ASSERT_EQ(3u, ewk_back_forward_list_count(list));
...
static void onFormAboutToBeSubmitted(void* userData, Evas_Object*, void* eventInfo)
{
    ...
    ASSERT_EQ(3u, eina_list_count(fieldNames));
    void* data;
...
// theme is bit different so disabled.
TEST_F(EWK2UnitTestBase, DISABLED_ewk_view_theme_set)
{
...
//it is overriden
TEST_F(EWK2UnitTestBase, DISABLED_ewk_view_run_javascript_alert)
{
...
//it is overriden
TEST_F(EWK2UnitTestBase, DISABLED_ewk_view_run_javascript_confirm)
{
...
//it is overriden
TEST_F(EWK2UnitTestBase, DISABLED_ewk_view_run_javascript_prompt)
{
...
// Failed with lock
TEST_F(EWK2UnitTestBase, DISABLED_ewk_view_page_contents_get)
{
...
TEST_F(EWK2UnitTestBase, ewk_view_layout_fixed)
{
...
TEST_F(EWK2UnitTestBase, ewk_view_layout_fixed_size)
{
...
TEST_F(EWK2UnitTestBase, ewk_view_page_zoom_set)
{
    ASSERT_TRUE(loadUrlSync(environment->defaultTestPageUrl()));
...
TEST_F(EWK2UnitTestBase, ewk_view_contents_size_get)
{
