...
# FIXME: Tizen specific macros for TIZEN_ALL_IN_ONE
macro(WRITE_FILE_IF_CHANGED _filename _message)
    if (EXISTS "${_filename}")
        file(READ "${_filename}" _old_content)
    endif ()

    if (NOT _old_content STREQUAL _message)
        file(WRITE "${_filename}" "${_message}")
    endif ()
endmacro()
