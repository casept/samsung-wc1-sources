...
#define WTF_USE_LEGACY_STYLE_ABSTRACT_CLIPBOARD_CLASS PLATFORM(IOS) || ENABLE(TIZEN_CLIPBOARD)
...
namespace WebCore {
    ...
    public:
        ...
        LEGACY_VIRTUAL void setData(const String& type, const String& data) LEGACY_PURE;
