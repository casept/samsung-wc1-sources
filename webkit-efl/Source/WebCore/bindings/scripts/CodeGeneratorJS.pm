...
sub GenerateGetOwnPropertySlotBody
{
    ...
    if ($indexedGetterFunction || $interface->extendedAttributes->{"CustomIndexedGetter"}) {
        ...
        if ($interface->extendedAttributes->{"CustomIndexedGetter"} || $indexedGetterFunction->signature->type eq "DOMString") {
...
sub GenerateHeader
{
    ...
    if ($interface->extendedAttributes->{"CustomEnumerateProperty"} || $indexedGetterFunction || $interface->extendedAttributes->{"CustomIndexedGetter"}) {
...
sub GenerateImplementation
{
    ...
    if (($indexedGetterFunction || $interface->extendedAttributes->{"CustomIndexedGetter"}) && !$interface->extendedAttributes->{"CustomEnumerateProperty"}) {
    ...
    if ($indexedGetterFunction && !$hasNumericIndexedGetter && !$interface->extendedAttributes->{"CustomIndexedGetter"}) {
    ...
    if ($hasNumericIndexedGetter && !$interface->extendedAttributes->{"CustomIndexedGetter"}) {
