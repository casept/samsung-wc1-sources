...
public:
    ...
    virtual int offsetForPosition(float x, bool includePartialGlyphs = true, bool forEllipsis = false) const;
#else
...
protected:
    ...
    void paintCompositionUnderlineBackground(GraphicsContext*, const FloatPoint& boxOrigin, RenderStyle*, const Font&, const CompositionUnderline);
