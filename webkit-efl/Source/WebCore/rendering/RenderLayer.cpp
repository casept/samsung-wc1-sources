...
void RenderLayer::updateScrollInfoAfterLayout()
{
    ...
    if (m_backing && m_backing->graphicsLayer()) {
        backing()->graphicsLayer()->setHorizontalSnapOffsets(horizontalSnapOffsets());
        backing()->graphicsLayer()->setVerticalSnapOffsets(verticalSnapOffsets());
    }
#endif
#endif
}
