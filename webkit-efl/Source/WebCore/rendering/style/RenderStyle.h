...
#define SET_VAR_SCROLL_SNAP(group, variable, value) \
    if (!compareEqual(group->variable, value)) \
...
// attribute setter methods
    ...
    void setScrollSnapPointsX(PassOwnPtr<ScrollSnapPoints>);
    void setScrollSnapPointsY(PassOwnPtr<ScrollSnapPoints>);
    void setScrollSnapDestination(const LengthSize&);
    void setScrollSnapCoordinates(const Vector<LengthSize>&);
#endif
