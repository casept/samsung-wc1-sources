...
void playerVolumeChangedCallback(GObject*, GParamSpec*, FullscreenVideoControllerGStreamer* controller)
{
    controller->volumeChanged();
}

void playerMuteChangedCallback(GObject*, GParamSpec*, FullscreenVideoControllerGStreamer* controller)
{
