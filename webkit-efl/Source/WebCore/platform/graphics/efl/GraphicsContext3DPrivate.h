...
private:
    ...
    void releaseOffScreenSurfaces();
    GLPlatformSurface* nextOffScreenSurface();
#endif
#if ENABLE(TIZEN_BROWSER_DASH_MODE)
    void webglDashModeFired(Timer<GraphicsContext3DPrivate>*) { };
#endif
...
#if ENABLE(TIZEN_WEBGL_MULTIBUFFER)
    Vector<OwnPtr<GLPlatformSurface> > m_offScreenSurfaces;
    GLPlatformSurface* m_currentOffScreenSurface;
    int m_maxSufaceCount;
...
#if ENABLE(TIZEN_BROWSER_DASH_MODE)
    Timer<GraphicsContext3DPrivate> m_webglDashModeTimer;
#endif
};
